        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Seorang Mahasiswa Sistem Informasi yang memiliki ketertarikan
              besar dalam pengembangan Web Development Terkhususnya FullStack.
              Saya berfokus pada menciptakan pengalaman digital yang menarik dan
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="https://drive.google.com/drive/folders/1bHu6-clv-x0jlu9a_uQf2uhkw3gPTQCn?usp=sharing"
