...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/khalifa-al-hasan-a118562a0/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@aal.psd",
    icon: Instagram,
    url: "https://www.instagram.com/aal.psd/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Tricky to Easy",
    icon: Youtube,
    url: "https://www.youtube.com/@Tricky-Easy",
    color: "#FF0000",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@aethergraphic?is_from_webapp=1&sender_device=pc",
    color: "black",
